...
void triInitialize( struct controlAll *all, struct laser *point, struct angle *angle1, struct angle *angle2, struct spectral *spectrum1, struct spectral *spectrum2, struct control *c)
{
    struct LamportQueue *lidar = all->lidar;
    struct LamportQueue *angles = all->angles;
    struct LamportQueue *spectral = all->spectral;
